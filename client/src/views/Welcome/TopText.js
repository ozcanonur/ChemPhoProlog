  ...
  return (
    <CardGeneric color='primary' cardTitle='What is ChemPhoProlog?'>
      <Typography variant='body1'>
        ...
        initially Boolean nature. This allowed us to identify previously unreported inhibitor-kinase
        relationships which could offer novel therapeutic targets for further investigation. We also present
        the model and its findings in a human readable and explanation-integrated manner. This offers an
        open-source model blueprint to act as a resource for its application in more and diverse data sets.
        <br />
        <br />
        The diverse and highly complex nature of modern phosphoproteomics research produces a high volume of
        data. Chemical phosphoproteomics especially, is amenable to a variety of analytical approaches. In
