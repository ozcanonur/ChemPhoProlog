        ...
        <GridContainer direction='row' alignItems='stretch'>
          <GridItem lg={6}>
            ...
            >
              ...
              scoring system, with which we were able to expand from its
              initially Boolean nature. This allowed us to identify 16
              previously unreported inhibitor-kinase relationships which could
